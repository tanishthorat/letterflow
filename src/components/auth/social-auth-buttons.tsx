  ...
  return (
    <div className="space-y-3">
      ...
      <Button
        type="button"
        variant="outline"
        className="w-full h-10 bg-input dark:bg-input-dark border-border dark:border-border-dark hover:bg-secondary dark:hover:bg-secondary/20"
        disabled={isLoading}
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-xs uppercase">
          <span className="px-2 bg-card dark:bg-card text-muted">
